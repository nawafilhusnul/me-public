export default function Carousel(){
  return (
    <div className="carousel w-full lg:max-w-[50%] mx-auto flex rounded-lg shadow-lg pb-10">
      <div id="slide1" className="carousel-item relative w-full">
        <img src="https://firebasestorage.googleapis.com/v0/b/me-dashboard-4830a.appspot.com/o/pjsa%2Caceh.jpg?alt=media" className=" w-full" />
